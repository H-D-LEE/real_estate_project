...
# GitHub raw 파일 URL
url = 'https://raw.githubusercontent.com/aaqq8/SteadyEstate/main/%EA%B8%B0%EC%A4%80%EA%B8%88%EB%A6%AC_2013_2023.xlsx'
...
if response.status_code == 200:
    ...
    price_data.set_index(df['연월일'], inplace=True)  # '시도'를 인덱스로 설정
