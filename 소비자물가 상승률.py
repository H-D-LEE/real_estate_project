...
# GitHub raw 파일 URL
url = 'https://raw.githubusercontent.com/aaqq8/SteadyEstate/main/%EC%86%8C%EB%B9%84%EC%9E%90%EB%AC%BC%EA%B0%80%20%EC%83%81%EC%8A%B9%EB%A5%A0.xlsx'
...
if response.status_code == 200:
    ...
    price_data.set_index(df['연월'], inplace=True)  # '시도'를 인덱스로 설정
